        ...
        messages: [
          {
            ...
            content: {
              type: "text",
              text: `Review Metron position ${position_id}. Objective: ${objective}. Use metron_position_get, metron_position_timeline, metron_risk_liquidation, and metron_risk_regime. Cite returned provenance and do not recommend execution without explicit approval.`,
            },
          },
        ],
      };
        ...
        messages: [
          {
            ...
            content: {
              type: "text",
              text: `Prepare a recovery runbook for Metron position ${position_id}. Incident: ${incident}. First call metron_recovery_rank with the current policy, then present the ranked actions and required approval_id. Never call metron_execution_submit until the user explicitly approves the exact action list.`,
            },
          },
        ],
      };
